...
const draw = (props) => {
    ...
    y.domain([d3.min(data, function(d) { return d.stmts; }) - 5, 100]);
    svg.append("g")
      .attr("class", "x axis")
    ...
    svg.selectAll(".dot")
        ...
        .attr("cy", function(d) { return y(d.stmts) })
        .attr("r", 5);
    ...
    svg.selectAll(".text")
        ...
        .attr("y", function(d) { return y(d.stmts) })
        .attr("dy", "-10")
        .text(function(d) {return d.stmts; });
}
